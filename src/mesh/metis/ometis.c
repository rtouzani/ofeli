                  ...
                  idxtype *perm, idxtype *iperm) 
{
  ...
  MlevelNestedDissection(&ctrl, &graph, iperm, (float)ORDER_UNBALANCE_FRACTION, *nvtxs);
                  ...
                  idxtype *perm, idxtype *iperm) 
{
  ...
  * Do the nested dissection ordering 
  ...
  if (ctrl.oflags&OFLAG_CCMP) 
    MlevelNestedDissectionCC(&ctrl, &graph, iperm, (float)ORDER_UNBALANCE_FRACTION, graph.nvtxs);
  else
    MlevelNestedDissection(&ctrl, &graph, iperm, (float)ORDER_UNBALANCE_FRACTION, graph.nvtxs);
...
void SplitGraphOrder(CtrlType *ctrl, GraphType *graph, GraphType *lgraph, GraphType *rgraph)
{
  ...
  idxtype *xadj, *vwgt, *adjncy, *label, *where, *bndptr, *bndind;
