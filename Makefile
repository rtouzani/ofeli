...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = i386-apple-darwin15.3.0
host_triplet = i386-apple-darwin15.3.0
subdir = .
...
AUTOMAKE = ${SHELL} /Users/touzani/ofeli/ofeli/missing automake-1.15
AWK = gawk
CC = gcc
...
OFELI_LIB = -lofeli
OFELI_LIBS = -lofeli  -lpetsc  -lmpi  -L${exec_prefix}/lib    
PACKAGE = ofeli
PACKAGE_BUGREPORT = 
PACKAGE_NAME = ofeli
PACKAGE_STRING = ofeli 3.1.0
